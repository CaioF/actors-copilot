...
interface PageProps {
  searchParams?: Promise<{ enrichAuditionId?: string }>;
}
 ...
 */
export default async function NewAuditionPage({ searchParams }: PageProps) {
  ...
  return (
    <main className="flex flex-1 flex-col h-full bg-[#F5F0E8]">
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-8">
        <AuditionWizard mode="brief" auditionId={enrichAuditionId} />
      </div>
    </main>
  );
}
