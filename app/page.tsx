    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#152323]">
      ...
      <div className="relative z-10 flex flex-col items-center gap-10">
        ...
        <div className="flex flex-col items-center text-center">
          <h1 className="font-title text-5xl md:text-6xl text-[#EFEADD] tracking-wide">
            Welcome to
          </h1>
          
          <h2 className="font-title mt-[-4px] mb-[-4px] text-7xl md:text-[8rem] font-bold text-[#F2671A] leading-[0.9] tracking-wider">
            The Actors Copilot
          </h2>
          
          <h3 className="font-title text-5xl md:text-6xl text-[#EFEADD] tracking-wide">
